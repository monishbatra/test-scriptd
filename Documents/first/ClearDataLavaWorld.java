...
public class ClearDataLavaWorld{
  ...
  @Test()
  public void clearDataAndLaunch() throws InterruptedException, IOException {
	  dr.sendKeyEvent(AndroidKeyCode.HOME);
		...
		// WebElement fn=dr.findElementByName("Lava World");
		  new TouchAction((MobileDriver) dr).longPress(dr.findElementByName("Lava World")).moveTo(378,139).release().perform();
