...
public class WifiDisable{
  ...
  @Test()
  public void EnableOrDisableWifi() throws InterruptedException, IOException {
	  //dr.findElement(By.id("launcher3.android.com.hivelauncher:id/hotseat")).click();
	  dr.openNotifications();
	  Thread.sleep(2000);
	  dr.swipe(346,154,328,906,1000);
	  dr.findElement(By.xpath("//android.widget.ImageView[@bounds='[89,416][153,464]']")).click();
